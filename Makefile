default:
		...
		ccache g++ -O3 -std=gnu++0x -DCLDEM_VTK -I/usr/include/eigen3 -I/usr/include/vtk-5.6 -lvtkCommon -lvtkIO -shared -fPIC -o _clDem.so cl/Simulation.cpp cl/Collider.cpp cl/wrapper.cpp -lboost_python -lOpenCL -L/usr/lib64 `pkg-config python --cflags` -Wno-deprecated
